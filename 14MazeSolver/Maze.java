...
public class Maze{
  ...
  */
  ...
  public Location[] getNeighbors(Location L){
    ...
    if (isValid(x-1,y)){
      neighbors[size] = new Location(x-1,y,L,Math.abs(x-1-end.getX())+Math.abs(y-end.getY()),nDist);
      size++;
    }
    if (isValid(x+1,y)){
      neighbors[size] = new Location(x+1,y,L,Math.abs(x+1-end.getX())+Math.abs(y-end.getY()),nDist);
    ...
    if (isValid(x,y-1)){
      neighbors[size] = new Location(x,y-1,L,Math.abs(x-end.getX())+Math.abs(y-1-end.getY()),nDist);
      size++;
    }
    if (isValid(x,y+1)){
      neighbors[size] = new Location(x,y+1,L,Math.abs(x-end.getX())+Math.abs(y+1-end.getY()),nDist);
